...
//提示框: info, success, warning, error(不写类型默认info)
define([':iziToast'],function (iziToast) {

	return function (messageContent,messageType) {
		iziToast.settings({
			timeout: 5000,
			position: 'topRight',
			// imageWidth: 50,
...
//确认框
define('confirm',[':iziToast'],function (iziToast) {
